...
export const iswdigit = (code: number): boolean =>
...
export const iswxdigit = (code: number): boolean =>
    (code > 47 && code < 58) || // numeric 0-9
...
export const iswalpha = (code: number): boolean =>
...
export const iswcntrl = (code: number): boolean =>
    (code > -1 && code < 32) || code === 127;
...
export const iswalnum = (code: number): boolean =>
    (code > 47 && code < 58) || // numeric 0-9
    (code > 64 && code < 91) || // upper A-Z
    (code > 96 && code < 123); // lower a-z
