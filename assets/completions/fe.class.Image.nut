 ...
 * @type {feImage}
 * @alias fe.Image
 * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L453
 */
class feImage {
     ...
     * @default `0`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L463
     */
    x = 0.0;
     ...
     * @relative To the top-left corner of the parent Surface.
     * @default `0`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L464
     */
    y = 0.0;
     ...
     * @default `0.0`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L465
     */
    width = 0.0;
     ...
     * @default `0.0`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L467
     */
    height = 0.0;
     ...
     * @default `true`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L469
     */
    visible = true;
     ...
     * @default `0.0`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L471
     */
    rotation = 0.0;
     ...
     * @default `255`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L473
     */
    red = 0;
     ...
     * @default `255`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L475
     */
    green = 0;
     ...
     * @default `255`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L477
     */
    blue = 0;
     ...
     * @default `255`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L479
     */
    alpha = 0;
     ...
     * @default `0`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L481
     */
    index_offset = 0;
     ...
     * Use to select content adjacent to the current selection.
     * @default `0`
     * @version AM_1.5.0 https://github.com/mickelson/attract/blob/v1.5.0/Layouts.md?plain=1#L1060
     */
    filter_offset = 0;

    /**
     * The Shader applied to the element's texture.
     * @version AM_1.2.0 https://github.com/mickelson/attract/blob/v1.2.0/Layouts.md?plain=1#L671
     */
    shader = feShader();
     ...
     * @default `0.0`
     * @version AM_1.2.2 https://github.com/mickelson/attract/blob/v1.2.2/Layouts.md?plain=1#L652
     */
    skew_x = 0.0;
     ...
     * @default `0.0`
     * @version AM_1.2.2 https://github.com/mickelson/attract/blob/v1.2.2/Layouts.md?plain=1#L655
     */
    skew_y = 0.0;
     ...
     * @default `0.0`
     * @version AM_1.2.2 https://github.com/mickelson/attract/blob/v1.2.2/Layouts.md?plain=1#L658
     */
    pinch_x = 0.0;
     ...
     * @default `0.0`
     * @version AM_1.2.2 https://github.com/mickelson/attract/blob/v1.2.2/Layouts.md?plain=1#L661
     */
    pinch_y = 0.0;
     ...
     * @default `0.0`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L491
     */
    subimg_x = 0.0;
     ...
     * The sub-image is the slice of the texture used for display.
     * @default `0.0`
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L493
     */
    subimg_y = 0.0;
     ...
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L495
     */
    subimg_width = 0.0;
     ...
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L497
     */
    subimg_height = 0.0;
     ...
     * @default `Vid.Default`
     * @version AM_1.3.0-beta1 https://github.com/mickelson/attract/blob/v1.3.0-beta1/Layouts.md?plain=1#L774
     */
    video_flags = Vid;
     ...
     * @default `true`
     * @version AM_1.3.0-beta1 https://github.com/mickelson/attract/blob/v1.3.0-beta1/Layouts.md?plain=1#L783
     */
    video_playing = true;
     ...
     * @version AM_1.3.0-beta1 https://github.com/mickelson/attract/blob/v1.3.0-beta1/Layouts.md?plain=1#L787
     */
    file_name = "";
     ...
     * @version AM_1.5.0 https://github.com/mickelson/attract/blob/v1.5.0/Layouts.md?plain=1#L1108
     */
    trigger = Transition;
     ...
     * @default `false`
     * @version AM_1.2.0 https://github.com/mickelson/attract/blob/v1.2.0/Layouts.md?plain=1#L669
     */
     ...
     * @dynamic Updated on `FromOldSelection` and `ToNewList` Transitions.
     * @version AM_1.3.2 https://github.com/mickelson/attract/blob/v1.3.2/Layouts.md?plain=1#L839
     *
     * @property {integer} video_time
     * The current video time in milliseconds.
     * @dynamic Updated on `FromOldSelection` and `ToNewList` Transitions.
     * @version AM_1.3.2 https://github.com/mickelson/attract/blob/v1.3.2/Layouts.md?plain=1#L840
     *
     * @property {integer} texture_width
     * The width of the texture.
     * @dynamic Updated on `FromOldSelection` and `ToNewList` Transitions.
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L489
     *
     * @property {integer} texture_height
     * The height of the texture.
     * @dynamic Updated on `FromOldSelection` and `ToNewList` Transitions.
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L490
     *
     ...
     * @version AM_1.0.2 https://github.com/mickelson/attract/blob/v1.0.2/Layouts.md?plain=1#L505
     */
