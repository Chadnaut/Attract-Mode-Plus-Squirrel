 ...
 * @type {feOverlay}
 * @alias fe.Overlay
 * @version AM+_3.2.0 https://github.com/oomek/attractplus/blob/master/Layouts.md#feoverlay-1
 * @since AM_1.4.1 https://github.com/mickelson/attract/blob/v1.4.1/Layouts.md?plain=1#L951
 */
class feOverlay {
    /**
     * @ignore
     ...
     * @version AM+_3.2.0 https://github.com/oomek/attractplus/blob/master/Layouts.md#feoverlay-1
     * @since AM_1.4.1 https://github.com/mickelson/attract/blob/v1.4.1/Layouts.md?plain=1#L959
     *
     * @property {integer} list_index
     * The index of the selected option.
     * @version 🔶AM+_3.2.0 https://github.com/oomek/attractplus/blob/master/Layouts.md#feoverlay-1
     * @since 🔶AM+_3.2.0 https://github.com/oomek/attractplus/blob/3.2.0/Layouts.md?plain=1#L1427
     *
     * @property {integer} list_size
     * The size of the overlay list.
     * @version 🔶AM+_3.2.0 https://github.com/oomek/attractplus/blob/master/Layouts.md#feoverlay-1
     * @since 🔶AM+_3.2.0 https://github.com/oomek/attractplus/blob/3.2.0/Layouts.md?plain=1#L1428
     */
    function _get() {}
     ...
     * @version AM+_3.2.0 https://github.com/oomek/attractplus/blob/master/Layouts.md#feoverlay-1
     * @since AM_2.0.0-rc1 https://github.com/mickelson/attract/blob/v2.0.0-rc1/Layouts.md?plain=1#L1201
     */
     ...
     * @version AM+_3.2.0 https://github.com/oomek/attractplus/blob/master/Layouts.md#feoverlay-1
     * @since AM_2.0.0-rc1 https://github.com/mickelson/attract/blob/v2.0.0-rc1/Layouts.md?plain=1#L1209
     */
     ...
     * @param {array(string)} options The array of strings to use for list options.
     ...
     * @returns {integer}
     * @version AM+_3.2.0 https://github.com/oomek/attractplus/blob/master/Layouts.md#feoverlay-1
     * @since AM_1.4.1 https://github.com/mickelson/attract/blob/v1.4.1/Layouts.md?plain=1#L964
     */
     ...
     * @returns {string}
     * @version AM+_3.2.0 https://github.com/oomek/attractplus/blob/master/Layouts.md#feoverlay-1
     * @since AM_1.4.1 https://github.com/mickelson/attract/blob/v1.4.1/Layouts.md?plain=1#L974
     */
     ...
     * @version AM+_3.2.0 https://github.com/oomek/attractplus/blob/master/Layouts.md#feoverlay-1
     * @since AM_1.6.2 https://github.com/mickelson/attract/blob/v1.6.2/Layouts.md?plain=1#L1160
     */
    function splash_message(title, footer="") {}
}
